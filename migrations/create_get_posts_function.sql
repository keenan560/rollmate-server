-- Create get_posts_with_details function based on your actual schema
-- This function returns posts with user details, likes, comments, and media_urls
...
WHERE routine_name = 'get_posts_with_details';
