-- ============================================
-- COMPLETE MIGRATION FOR MULTIPLE IMAGES SUPPORT
-- Run this entire file in your Supabase SQL Editor
-- ============================================

-- STEP 1: Add media_urls column to posts table (if not exists)
ALTER TABLE posts 
...
-- STEP 2: Create photo_likes table for individual photo likes
...
-- STEP 4: Create get_posts_with_details function with media_urls support
...
-- STEP 5: Create/Update get_post_comments function (if needed)
...
-- STEP 6: Create function to get photo likes for a post
...
WHERE routine_name IN ('get_posts_with_details', 'get_post_comments', 'get_photo_likes_for_post')
